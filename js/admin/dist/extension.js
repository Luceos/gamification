            ...
            SettingsPage = function (_Component) {
                ...
                babelHelpers.createClass(SettingsPage, [{
                    ...
                    value: function view() {
                        ...
                        return [m('div', { className: 'SettingsPage' }, [m('div', { className: 'container' }, [m('form', { onsubmit: this.onsubmit.bind(this) }, [this.values.convertedLikes() === undefined ? (m('div', { className: 'helpText' }, app.translator.trans('reflar-gamification.admin.page.convert.help')), Button.component({
                            type: 'button',
